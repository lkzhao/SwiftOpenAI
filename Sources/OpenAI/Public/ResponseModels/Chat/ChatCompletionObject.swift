    ...
    public struct ChatMessage: Decodable {
      ...
      public struct Image: Decodable {
        public struct ImageURL: Decodable {
          /// Base64 encoded image bytes generated by the model
          public let url: URL
        }
      ...
      /// If the image output modality is requested, this object contains data about the image response from the model. [Learn more](https://platform.openai.com/docs/guides/images-vision).
